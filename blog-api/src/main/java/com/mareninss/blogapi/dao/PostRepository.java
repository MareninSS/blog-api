...
public interface PostRepository extends JpaRepository<Post, Integer> {
  ...
  @Query(value = "SELECT * FROM blog_db.posts where is_active = :isActive  and time < :time and moderation_status = :moderationStatus", nativeQuery = true)
  ...
  @Query(value = "SELECT * FROM blog_db.posts where is_active = :isActive  and time < :time and moderation_status = :moderationStatus limit :limit offset :offset", nativeQuery = true)
